...
Private Sub print_bon(tunai As Integer)
    ...
    If is_new = True Or temp_value = True Then
        ...
        Printer.Print Tab(1); "ICE SKATING CHIP";
        Dim total_bel As Integer
        total_bel = 0
        Printer.FontSize = 10
        ...
        Do While Not rsJual.EOF
            ...
            Printer.Print Tab(2); rsJual!jumlah_jual; Tab(7); "x"; Tab(18 - Len(Format(rsJual!harga_jual, "###,###,##0"))); Format(rsJual!harga_jual, "###,###,##0"); Tab(30 - Len(Format(bayar, "###,###,##0"))); Format(bayar, "###,###,##0")
            total_bel = total_bel + rsJual!jumlah_jual
            rsJual.MoveNext
        Loop
        Printer.Print Tab(2); "                                                                  ";
        Printer.FontSize = 10
        If priceToNum(txt_diskon) > 0 Then
            Printer.Print Tab(2); "Total"; Tab(15); "Rp."; Tab(30 - Len(Format(txt_subTotal, "###,###,##0"))); Format(txt_subTotal, "###,###,##0")
            Printer.Print Tab(2); "Diskon"; Tab(15); "Rp."; Tab(30 - Len(Format(txt_diskon, "###,###,##0"))); Format(txt_diskon, "###,###,##0")
        End If
        ''test
        'Printer.print tab(3); "Pajak Restoran 10%"; Tab(20); "Rp."; Tab(35 - Len(Format(txt_ppn, "###,###,##0"))); Format(txt_ppn, "###,###,##0")
        Printer.Print Tab(2); "------------------------------------------------------------------";
        Printer.FontSize = 12
        Printer.Print Tab(1); "Grand Total"; Tab(13); "Rp."; Tab(25 - Len(Format(txt_grandTotal, "###,###,##0"))); Format(txt_grandTotal, "###,###,##0")
    ...
    ''nyelip di sini
        ...
        Else
            Printer.Print Tab(5); "-NON TUNAI-";
        End If
        Printer.Print Tab(2); "                                                             ";
        'Printer.FontSize = 10
        Printer.Print Tab(2); "                                                             ";
        Printer.FontSize = 8
        'Printer.Print Tab((40 - Len("*Periksalah uang kembalian anda*")) / 2); "*Periksalah uang kembalian anda*";
        'Printer.Print Tab((40 - Len("*sebelum meninggalkan kasir*")) / 2); "*sebelum meninggalkan kasir*";
        Printer.Print Tab(2); "Total Items   : "; total_bel;
